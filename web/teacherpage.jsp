...
<section class="section1" >
  ...
  <div class="tb2-content" style="overflow-y:scroll;height: 250px">
    ...
    <table cellpadding="0" cellspacing="0" border="1" id="table2">
      <tbody>
          ...
          <td><% out.println(""+(Double.parseDouble(rs3.getString("att"))/Double.parseDouble(rs3.getString("cond"))*100.0));%></td>
  ...
  date_from = 'd'+date_from;
   ...
   date_to = 'd'+date_to;
              out.println("date_from:" + date_from +" date_to:"+date_to);
    ...
    ResultSet rs4 = ps4.executeQuery();
     ...
     try{
         ...
         PreparedStatement ps5 =con.prepareStatement("select "+date_from+","+date_to+" from "+sub_report+"_"+classreport+";");
         ps5.executeQuery();
     }
     catch(Exception e)
     {
     ...
     PreparedStatement ps7 =con.prepareStatement("select rollno from "+sub_report+"_"+classreport+";");
     ResultSet rs7=ps7.executeQuery();  
     PreparedStatement ps6 =con.prepareStatement("select column_name from information_schema.columns where table_name='"+sub_report+"_"+classreport+"' order by ordinal_position;");
    ...
    String match="NO";
     ...
     j=0;i=0;
         while(rs6.next())
         {
            ...
            if(match.equals("YES"))
            {
            PreparedStatement ps8 =con.prepareStatement("select "+columns+" from "+sub_report+"_"+classreport+";");
        ...
        document.open();
                String pdf_header = "                                                                             "  + class_report +"       "+ sub_report.toUpperCase() +"          " +"ATTENDANCE";
  ...
  <div class="tbl-header">
    <table cellpadding="0px" cellspacing="0" border="0">
      <thead>
        ...
        <div class="tb2-content" style="overflow-y:scroll;height: 300px ">
  ...
  String cutoff = request.getParameter("cut_off");
    ...
    ResultSet rs9 = ps9.executeQuery();
     ...
     String sub_defaulter = rs9.getString("subject");
         ...
         PreparedStatement ps10 =con.prepareStatement("select * from "+sub_defaulter+"_"+defaulterreport+";");
